package com.knoldus.cipher

import com.knoldus.client.InternalClient
import com.knoldus.models.{CipherForm, DecryptCipherForm, DecryptedCipher, EncryptedCipher}
...
class CipherService(
  ...
  private[this] def generatePassword: String = RandomStringUtils.randomAlphanumeric(64)

  override def create(cleartext: String, attributes: Map[String, String])(implicit
      ec: ExecutionContext
  ): Future[Either[String, EncryptedCipher]] = {
